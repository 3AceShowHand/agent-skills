...
- High: likely bug, production instability, broken upgrade behavior, unsafe migration, or significant test gap.
...
- Filling the report with low-value suggestions when no actionable issue exists.
